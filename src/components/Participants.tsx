...
const Participants: React.FC<Props> = ({ isAdmin, lang, theme }) => {
    ...
    return (
        <div className={`w-full mx-auto px-6 space-y-10 pb-24 animate-in slide-in-from-bottom duration-500 transition-colors duration-300 ${theme === 'dark' ? 'bg-[#001219]' : ''}`}>
            ...
            <AnimatePresence>
                {selectedDiver && (
                    <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-black/80 backdrop-blur-xl overflow-y-auto">
                        <motion.div
                            initial={{ opacity: 0, scale: 0.9, y: 30 }}
                            animate={{ opacity: 1, scale: 1, y: 0 }}
                            exit={{ opacity: 0, scale: 0.9, y: 30 }}
                            className={`w-full max-w-lg rounded-[60px] overflow-hidden relative shadow-2xl border-none my-auto ${theme === 'dark' ? 'bg-[#001219] text-white' : 'bg-white text-[#001219]'}`}
                        >
                            <button
                            ...
                            <div className="pt-44 pb-12 px-10 text-center">
                                ...
                                <div className="mt-10 space-y-4 text-left">
                                    ...
                                    {isAdmin && (
                                        <div className="pt-10 mt-6 border-t border-gray-500/10 space-y-6">
