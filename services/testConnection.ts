...
export const testSupabaseConnection = async () => {
  ...
  try {
    // TEST 1: Check 'users' table existence and read access
    ...
    // TEST 2: Check 'payments' table existence and read access
    ...
    // TEST 3: Check RLS by attempting to insert a test record (expected to fail if RLS is strict/broken)
